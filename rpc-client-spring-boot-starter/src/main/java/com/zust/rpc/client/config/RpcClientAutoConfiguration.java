...
import com.zust.rpc.client.processor.RpcClientProcessor;
import com.zust.rpc.core.balancer.FullRoundBalance;
import com.zust.rpc.core.balancer.LoadBalance;
import com.zust.rpc.core.balancer.RandomBalance;
import com.zust.rpc.core.discovery.DiscoveryService;
import com.zust.rpc.core.discovery.ZookeeperDiscoveryService;
...
public class RpcClientAutoConfiguration {
     ...
     *
     * properties.getDiscoveryAddr() 有个默认地址
     *
     * 这里建立的一个 ZookeeperDiscoveryService 用于服务发现
     */
    @Bean
    @ConditionalOnMissingBean
